...
const PlayerCollisionBodyData = {
	...
	crouch:{left:[{x:17, y:33}, {x:17, y:63}, {x:32, y:63}, {x:32, y:33}],
		right:[{x:4, y:33}, {x:4, y:63}, {x:22, y:63}, {x:22, y:33}]},
...
const BasicEnemyCollisionBodyData = {
	...
	j_kick:{left:[{x:15, y:3}, {x:15, y:46}, {x:34, y:46}, {x:34, y:3}],
		right:[{x:2, y:2}, {x:2, y:46}, {x:24, y:46}, {x:24, y:2}]},
	sweep:{left:[{x:15, y:23}, {x:15, y:66}, {x:34, y:66}, {x:34, y:23}],
		right:[{x:2, y:23}, {x:2, y:66}, {x:24, y:66}, {x:24, y:23}]},
