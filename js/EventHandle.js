/**
 * @template {(...params: any[]) => void} T
 * @description A container of callbacks that can be fired when an event has occured.
...
function EventHandle() {
	 ...
	 * @type {{callback: T, context: any, isOnce: boolean}[]}
	 */
	const _handle = [];
	 ...
	 * @param {T} callback The callback function to unsubscribe. Must be the same reference.
	 */
	 ...
	 * @param {{callback: T, context: any, isOnce: boolean}[]} handleArray 
	 * @param  {...any} params 
	 */
