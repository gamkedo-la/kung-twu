...
const userStrings = {
	English: {
		...
		[STRINGS_KEY.GameVolume]:"Game Volume",
		...
		[STRINGS_KEY.Continue]:"[SPACE] Continue",
	...
	Spanish: {
		...
		[STRINGS_KEY.Play]:"[ESPACIO] Jugar",
		[STRINGS_KEY.GameVolume]:"Volumen de Juego",
		...
		[STRINGS_KEY.Continue]:"[ESPACIO] Continuar",
		...
		[STRINGS_KEY.HowToDash]:"[ESPACIO] para retroceder\nrápidamente de enemigos",
		...
		[STRINGS_KEY.LevelIntroText_Lvl1]:"Prepárate para aprender\nel desplazamiento inmediato\nde Shīfù Tigero.",
		[STRINGS_KEY.LevelIntroText_Lvl2]:"Prepárate para aprender\nla patada para barrer\n de Shīfù Whitebird.",
		[STRINGS_KEY.LevelIntroText_Lvl3]:"Prepárate para aprender\nla patada en salto\nde Shīfù Striker.",
		[STRINGS_KEY.LevelIntroText_Lvl4]:"Prepárate para aprender\nla patada en giro\n de Shīfù Leopald.",
		[STRINGS_KEY.LevelIntroText_Lvl5]:"Prepárate para recibir\nentendimiento\n de Shīfù Dorago.",
		[STRINGS_KEY.BossIntroText_Lvl1]:"Shīfù Tigero se acerca.",
		[STRINGS_KEY.BossIntroText_Lvl2]:"Shīfù Whitebird se acerca.",
		[STRINGS_KEY.BossIntroText_Lvl3]:"Shīfù Striker se acerca.",
		[STRINGS_KEY.BossIntroText_Lvl4]:"Shīfù Leopald se acerca.",
		[STRINGS_KEY.BossIntroText_Lvl5]:"Shīfù Dorago se acerca.",
		[STRINGS_KEY.ControlsText_Lvl2]:"[ESPACIO] Desplazamiento Inmediato",
		[STRINGS_KEY.ControlsText_Lvl3]:"[Agacharse + Patada] Barrido",
		[STRINGS_KEY.ControlsText_Lvl4]:"[Brinco + Patada] Patada en Brinco",
	...
	Japanese: {
		...
		[STRINGS_KEY.GameVolume]:"ゲームボリューム",
		...
		[STRINGS_KEY.Continue]:"[SPACE] やりなおす",
		...
		[STRINGS_KEY.LevelIntroText_Lvl1]:"シュフ・タイガーの\nバックダッシュを\nまなぶじゅんびをください。",
		[STRINGS_KEY.LevelIntroText_Lvl2]:"シュフ・ホワイトバーの\nレッグスイープを\nまなぶじゅんびをください。",
		[STRINGS_KEY.LevelIntroText_Lvl3]:"シュフ・ストライカーの\nジャンプキックを\nまなぶじゅんびをください。",
		[STRINGS_KEY.LevelIntroText_Lvl4]:"シュフ・レオポルドの\nスピンキックを\nまなぶじゅんびをください。",
		[STRINGS_KEY.LevelIntroText_Lvl5]:"シュフ・ドラゴのかいがんを\n.もらうじゅんびをください",
		[STRINGS_KEY.BossIntroText_Lvl1]:"シュフ・タイガーロがさししかかる。",
		[STRINGS_KEY.BossIntroText_Lvl2]:"シュフ・ホワイトバードがさししかかる。",
		[STRINGS_KEY.BossIntroText_Lvl3]:"シュフ・ストライカーのがさししかかる。",
		[STRINGS_KEY.BossIntroText_Lvl4]:"シュフ・レオポルドがさししかかる。",
		[STRINGS_KEY.BossIntroText_Lvl5]:"シュフ・ドラゴがさししかかる。",
		[STRINGS_KEY.ControlsText_Lvl2]:"[SPACE] Dash",
		[STRINGS_KEY.ControlsText_Lvl3]:"[Crouch + Kick]\nSweep",
		[STRINGS_KEY.ControlsText_Lvl4]:"[Jump + Kick]\nJump Kick",
		[STRINGS_KEY.ControlsText_Lvl5]:"[Dash + Kick]\nSpin Kick",
		[STRINGS_KEY.GangCount]:"のうどうてきのライバル",
		[STRINGS_KEY.Default]:"デフォルト",
	...
	French: {
		...
		[STRINGS_KEY.Russian]:"Русский",
		[STRINGS_KEY.Polish]:"Polski",
		[STRINGS_KEY.EnterToReturn]:"Appuyez sur [ENTRÉE] pour revenir",
		...
		[STRINGS_KEY.Resume]:"[ÉCHAP] Reprendre",
		[STRINGS_KEY.Controls]:"[C] Contrôles",
		[STRINGS_KEY.Quit]:"[Q] Quitter",
		[STRINGS_KEY.Continue]:"[ESPACE] Continuer",
		[STRINGS_KEY.End]:"[E] Fin",
		...
		[STRINGS_KEY.Rivals]:"Rivaux:",
		[STRINGS_KEY.Rivals_]:"Rivaux",
		...
		[STRINGS_KEY.RivalsToBeat]:"Rivaux\nÀ Battre",
		[STRINGS_KEY.LevelTime]:"Limite\nde Temps",
		[STRINGS_KEY.LevelIntroText_Lvl1]:"Préparez vous à\napprendre L'esquive\ndu Shīfù Tigero.",
		[STRINGS_KEY.LevelIntroText_Lvl2]:"Préparez vous à\napprendre Le balayage\ndes jambes du\nShīfù Oiseau Blanc.",
		[STRINGS_KEY.LevelIntroText_Lvl3]:"Préparez vous à\napprendre Le coup\nde pied sauté\n du Shīfù Frappeur.",
		[STRINGS_KEY.LevelIntroText_Lvl4]:"Préparez vous à\napprendre Le coup\nde pied rotatif\n du Shīfù Léopald.",
		[STRINGS_KEY.LevelIntroText_Lvl5]:"Préparez vous à\nrecevoir L'Eveil\ndu Shīfù Dorago.",
		...
		[STRINGS_KEY.ControlsText_Lvl2]:"[ESPACE] Esquive",
		[STRINGS_KEY.ControlsText_Lvl3]:"[Acroupis + Coup de Pied]\nBalayage",
		[STRINGS_KEY.ControlsText_Lvl4]:"[Saut + Coup de Pied]\nCoup de Pied Sauté",
		[STRINGS_KEY.ControlsText_Lvl5]:"[Esquive + Coup de Pied]\nCoup de Pied Rotatif",
		[STRINGS_KEY.GangCount]:"Rivaux actifs",
		[STRINGS_KEY.Default]:"Remettre aux valeurs par défaut",
	...
	Russian: {
		...
		[STRINGS_KEY.GameVolume]:"объем игры",
		...
		[STRINGS_KEY.Continue]:"[ПРОБЕЛ] продолжать",
		...
		[STRINGS_KEY.LevelIntroText_Lvl1]:"подготовиться\nк обучению\nShīfù тигра\nизворачиваться.",
		[STRINGS_KEY.LevelIntroText_Lvl2]:"подготовиться\nк обучению\nShīfù журавля\nподметание ног.",
		[STRINGS_KEY.LevelIntroText_Lvl3]:"подготовиться\nк обучению\nShīfù змеи\nпрыжок.",
		[STRINGS_KEY.LevelIntroText_Lvl4]:"подготовиться\nк обучению\nShīfù леопарда\nспиновой удар.",
		[STRINGS_KEY.LevelIntroText_Lvl5]:"подготовиться\nк приему\nShīfù дракона\nпросветление.",
	...
	Polish: {
		...
		[STRINGS_KEY.GameVolume]:"Głośność gry",
		...
		[STRINGS_KEY.Continue]:"[SPACE] Kontynuuj",
		...
		[STRINGS_KEY.HelpScreenContents]:"[STRZAŁKI lub WASD]\nPoruszanie\n[DO GÓRY lub C] Skok\n[G lub X] Cios\n[H lub X] Kopnięcie\n[V] Blok\n[S] or [Down] Kucnięcie", //\n[P] Pauza
		...
		[STRINGS_KEY.LevelIntroText_Lvl1]:"Przygotuj\nsię na naukę\nZrywu\nod Shīfù Tigero.",
		[STRINGS_KEY.LevelIntroText_Lvl2]:"Przygotuj\nsię na naukę\nPodcięcia\nod Shīfù Whitebird.",
		[STRINGS_KEY.LevelIntroText_Lvl3]:"Przygotuj\nsię na naukę\nKopnięcia z Wyskoku\nod Shīfù Striker.",
		[STRINGS_KEY.LevelIntroText_Lvl4]:"Przygotuj\nsię na naukę\nKopnięcia z Obrotu\nod Shīfù Leopald.",
		[STRINGS_KEY.LevelIntroText_Lvl5]:"Przygotuj\nsię na otrzymanie\noświecenia od\nShīfù Dorago.",
		...
		[STRINGS_KEY.ControlsText_Lvl3]:"[Kucnięcie + Kopnięcie]\nPodcięcie",
		[STRINGS_KEY.ControlsText_Lvl4]:"[Skok + Kopnięcie]\nKopnięcie z Wyskoku",
		[STRINGS_KEY.ControlsText_Lvl5]:"[Zryw + Kopnięcie]\nKopnięcie z Obrotu",
		[STRINGS_KEY.GangCount]:"Aktywni\nRywale",
		[STRINGS_KEY.Default]:"Przywróć\nDomyślą Wartość",
